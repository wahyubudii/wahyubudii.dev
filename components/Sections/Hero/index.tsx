    ...
    <>
      <div className="mr-24 w-full pb-14">
        <RoughNotationGroup show={true}>
          <h1 className='text-4xl font-bold after:content-["."]'>
            Hi there, I&#39;m{" "}
            <span>
              <RoughNotation animate={false} type="underline">
                Wahyu
              </RoughNotation>
            </span>
          </h1>
          <div className="mt-5 space-y-3 font-light leading-[26px] text-sm sm:text-normal text-slate-900 dark:text-white">
            <p>
              ...
              Becoming a better developer and growing a career in tech. Let`s
              hang out on{" "}
              <Link
            ...
            <p>
              ...
              <Link
                href="https://google.com"
                target="_blank"
                className='font-medium dark:text-black after:content-["."]'
              >
                <RoughNotation
                  multiline={true}
                  type="highlight"
              ...
              with Bachelor&#39;s degree in Informatics (Computer Science).
            </p>
            <p>
              I love making tools are user-friendly, simple and delightful. For
              now I&#39;m focusing on{" "}
              <span className="font-medium dark:text-black">
                <RoughNotation
                  multiline={true}
      ...
      <div className="sm:flex rounded-full p-[2px]">
        <div
          className="relative border-[2.5px] border-white mx-auto rounded-full h-72 w-72 sm:h-80 sm:w-80 lg:h-80 lg:w-80 xl:h-72 xl:w-72 ml-auto bg-center bg-cover flex"
          style={{ backgroundImage: `url(/images/photo_profile.jpg)` }}
        >
